...
--
-- Oracle DDL for Registry - OMAR Schema
--
...
-- ****** Cross check query column changed length from 4096 to 4000 so as to define as varchar2 ******
-- ******

CREATE TABLE adhocquery (
    id VARCHAR2(256) NOT NULL,
    home VARCHAR2(256),
    lid VARCHAR2(256) NOT NULL,
    objecttype VARCHAR2(256),
    status VARCHAR2(256) NOT NULL,
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    querylanguage VARCHAR2(256) NOT NULL,
...
CREATE TABLE association (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    associationtype VARCHAR2(128) NOT NULL,
    sourceobject VARCHAR2(64) NOT NULL,
    targetobject VARCHAR2(64) NOT NULL
...
CREATE TABLE auditableevent (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    requestid VARCHAR2(256) NOT NULL,
    eventtype VARCHAR2(256) NOT NULL,
    timestamp_ VARCHAR2(30) NOT NULL,
    user_ VARCHAR2(256) NOT NULL
...
CREATE TABLE classification (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    classificationnode VARCHAR2(64),
    classificationscheme VARCHAR2(64),
    classifiedobject VARCHAR2(64) NOT NULL,
...
CREATE TABLE classscheme (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    isinternal VARCHAR2(1) NOT NULL,
    nodetype VARCHAR2(128) NOT NULL
...
CREATE TABLE externalidentifier (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    registryobject VARCHAR2(64) NOT NULL,
    identificationscheme VARCHAR2(64) NOT NULL,
...
CREATE TABLE externallink (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    externaluri VARCHAR2(256) NOT NULL
);
...
CREATE TABLE extrinsicobject (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    isopaque VARCHAR2(1) NOT NULL,
    mimetype VARCHAR2(128),
    contentversionname VARCHAR2(16),
    contentversioncomment VARCHAR2(256)
);
...
CREATE TABLE federation (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    replicationsynclatency VARCHAR2(32)
...
CREATE TABLE registry (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    catalogingsynclatency VARCHAR2(32) DEFAULT 'P1D',
    conformanceprofile VARCHAR2(16),
    operator VARCHAR2(256) NOT NULL,
    replicationsynclatency VARCHAR2(32) DEFAULT 'P1D',
    specificationversion VARCHAR2(8) NOT NULL
...
CREATE TABLE servicebinding (
    ...
    accessuri VARCHAR2(256),
    targetbinding VARCHAR2(256)
...
CREATE TABLE specificationlink (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    servicebinding VARCHAR2(256) NOT NULL,
    specificationobject VARCHAR2(256) NOT NULL
...
CREATE TABLE subscription (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    selector VARCHAR2(256) NOT NULL,
    endtime VARCHAR2(30),
    notificationinterval VARCHAR2(32) DEFAULT 'P1D',
...
CREATE TABLE notification (
    ...
    versionname VARCHAR2(16),
    comment_ VARCHAR2(256),
    subscription VARCHAR2(256) NOT NULL
...
CREATE TABLE notificationobject (
    notificationid VARCHAR2(256) NOT NULL,
    registryobjectid VARCHAR2(256) NOT NULL
);
...
CREATE TABLE notifyaction (
    notificationoption VARCHAR2(256) NOT NULL,
...
--    home VARCHAR2(256),
--    lid VARCHAR2(256) NOT NULL,
--    objecttype VARCHAR2(256) NOT NULL,
--    status VARCHAR2(256) NOT NULL,
--    versionname VARCHAR2(16),
--    comment_ VARCHAR2(256)
--);
...
CREATE TABLE repositoryitem (
    lid VARCHAR2(256) NOT NULL,
    versionname VARCHAR2(16) NOT NULL,
    content BLOB
);
